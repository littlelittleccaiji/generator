...
public class MapperTask extends AbstractTask {
    ...
    public void run() throws IOException, TemplateException {
        ...
        if (!StringUtil.isBlank(parentForeignKey)) { // 多对多
            ...
            mapperData.put("InsertValues", GeneratorUtil.generateMapperInsertValues(tableInfos,StringUtil.firstToLowerCase(className)));
            ...
            mapperData.put("Association", "");
            mapperData.put("Collection", "");
            mapperData.put("InsertBatchValues", GeneratorUtil.generateMapperInsertBatchValues(tableInfos, StringUtil.firstToLowerCase(className)+"s"));
            mapperData.put("InsertValues", GeneratorUtil.generateMapperInsertValues(tableInfos,StringUtil.firstToLowerCase(className)));
            mapperData.put("UpdateProperties", GeneratorUtil.generateMapperUpdateProperties(tableInfos));
