...
public class GeneratorUtil {
    ...
    public static String getSelectByConditionWhere(List<ColumnInfo> infos){
        ...
        for (ColumnInfo info:infos) {
                ...
                sb.append("    ");
                sb.append("    ");
                sb.append("AND  ").append(info.getColumnName()+"="+"#{"+info.getPropertyName() +"}").append("\n");
                sb.append("    ");
                sb.append("    ");
                sb.append("</if>").append("\n");
        }
    ...
    public static String generateMapperInsertProperties(List<ColumnInfo> infos,String className) {
        StringBuilder sb = new StringBuilder();
        ...
        for (ColumnInfo info:infos) {
            ...
            sb.append("    ");
            sb.append("    ");
            sb.append(info.getColumnName()).append(",").append("\n");
            sb.append("    ");
            sb.append("    ");
            sb.append("</if>").append("\n");
        }
    ...
    public static String generateMapperInsertValues(List<ColumnInfo> infos,String className) {
        StringBuilder sb = new StringBuilder();
        ...
        for (ColumnInfo info:infos) {
            ...
            sb.append(info.getPropertyName());
            sb.append("!= null\" >").append("\n");
            sb.append("#{"+className+"."+info.getPropertyName() +"}").append(",").append("\n");
            sb.append("    ");
            sb.append("    ");
            sb.append("</if>").append("\n");
        }
    ...
    public static String generateMapperUpdateProperties(List<ColumnInfo> infos) {
        ...
        for (ColumnInfo info:infos) {
            ...
            sb.append("    ");
            sb.append("    ");
            sb.append(info.getColumnName()+"="+"#{"+info.getPropertyName() +"},").append("\n");
            sb.append("    ");
            sb.append("    ");
            sb.append("</if>").append("\n");
        }
